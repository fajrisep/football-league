...
class Isa extends Component {
    ...
    componentDidMount() {
        let url = 'https://www.thesportsdb.com/api/v1/json/1/lookuptable.php?l=4332&s=1819';
        axios.get(url)
            .then((res) => {
                    ...
                    <div className="container-fluid">
                        <div className="navbar-header row">
                            <div className="col-12 col-sm-2">
                                <img src="https://upload.wikimedia.org/wikipedia/en/f/f7/LegaSerieAlogoTIM.png" alt="serie-a-logo" className="img-logo" />
                            </div>
